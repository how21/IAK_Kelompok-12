<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-6">
            ...
            <x-text-input placeholder="email" id="email" class="w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
